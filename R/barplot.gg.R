...
function(x, position, 
         ...
         fill.name = ""){
  switch(position,
         stack = barplot.gg.stack(x, base_family = base_family, 
                                  ggtitle = ggtitle, 
                                  xlab = xlab, 
                                  ylab = "", 
                                  fill.name = ""),
         dodge = barplot.gg.dodge(x, base_family = base_family, 
                                  ggtitle = ggtitle, 
                                  xlab = xlab, 
                                  ylab = "", 
                                  fill.name = ""),
         fill = barplot.gg.fill(x, base_family = base_family, 
                                ggtitle = ggtitle, 
                                xlab = xlab, 
                                ylab = "", 
                                fill.name = ""))
}
barplot.gg.stack <- function(df, base_family = "", 
                             ggtitle = "", 
                             xlab = "", 
                             ylab = "", 
                             fill.name = ""){
...
barplot.gg.dodge <- function(df, base_family = "", 
                             ggtitle = "", 
                             xlab = "", 
                             ylab = "", 
                             fill.name = ""){
...
#  theme.kr +
  ...
  b3 <- b2 +
    geom_text(aes(y = df$Freq/2), 
              label = format(df[index, "Freq"], big.mark = ","), 
              position = position_dodge(width = 0.9)) +
    ggtitle(ggtitle)
return(b3)
}
barplot.gg.fill <- function(df, base_family = "", 
                            ggtitle = "", 
                            xlab = "", 
                            ylab = "", 
                            fill.name = ""){
