...
vote.seoul.class <- xtabs(counts ~ vote + class, data = sejong.poll.en, region == "Seoul", drop = TRUE)
...
```{r, Chungcheong}
vote.chung.class <- xtabs(counts ~ vote + class, data = sejong.poll.en, region == "Chungcheong", drop = TRUE)
