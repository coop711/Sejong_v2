...
b2.seoul <- b1.seoul +
  ...
  scale_fill_manual(name = "찬반", values = rainbow(2)[2:1], labels = vote.seoul.df$vote)
b2.seoul  
b3.seoul <- b2.seoul +
...
m3
m4 <- m3 + 
  geom_text(aes(x = center, y = label.height/2), label = format(vote.seoul.class.df$Freq, big.mark = ","), position = position_stack(reverse = TRUE))
m4
