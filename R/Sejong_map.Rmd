---
title: "Sejong National Referendum on the Map"
author: "coop711"
date: '2017 9 20 '
...
북한의 행정지도를 구하기 위하여 [Global Administrative Areas](https://www.gadm.org)에서 shape 파일을 다운로드한다.
...
### 시도 단위 행정경계도 읽어들이고, 데이터 만들기

```{r, results = 'hide'}
getwd()
ogrInfo(dsn = "../data/KOR_adm",  #> `ogrInfo()`
        layer = "KOR_adm0")
shp_S_1 <- readOGR(dsn = "../data/KOR_adm/", 
                layer = "KOR_adm1",
                stringsAsFactors = FALSE)
#                 encoding = "CP949")
ogrInfo(dsn = "../data/PRK_adm",  #> `ogrInfo()`
        layer = "PRK_adm1")
