...
#  geom_text(aes(y = y.coord), label = pie.label, family = "")
  geom_text(aes(y = y.coord), label = pie.label, family = "", position = position_stack())
pie.total.6
...
pie.gg(vote.df, ggtitle = "전체 찬반", font.family = "")
```
...
m2
m3 <- m2 + 
  geom_text(aes(x = center, y = 1.05), label = vote.seoul.class.p.df$class, family = "")
m3
m4 <- m3 + 
...
source("./mosaic.gg_win.R")
mosaic_gg
m5.seoul <- mosaic_gg(vote.seoul.class, base_family = "", ggtitle = "서울의 찬반", xlab = "계급")
m5.seoul
...
# source("./mosaic.gg.R")
m5.bureaus <- mosaic_gg(vote.region.bureaus[, -1], base_family = "", ggtitle = "지방관료의 찬반", xlab = "지역별 관료들의 비중")
m5.bureaus
...
# source("./mosaic.gg.R")
m5.commons <- mosaic_gg(vote.region.commons, base_family = "", ggtitle = "품관촌민의 찬반", xlab = "지역별 품관촌민의 비중")
m5.commons
...
par(mar = c(5.1, 4.1, 4.1, 8.1), xpd = TRUE, family = "")
...
# source("./mosaic.gg.R")
m5.chungcheong <- mosaic_gg(vote.chung.class[, -1], base_family = "", ggtitle = "충청도의 찬반", xlab = "계급")
m5.chungcheong
