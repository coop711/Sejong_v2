...
```{r, chungcheong}
par(family = "나눔고딕")
kable(format(vote.chung.class, big.mark = ","), caption = "충청도 사례", align = rep("r", 3))
kable(format(prop.table(vote.chung.class, margin = 2)*100, digits = 3, nsmall = 1), caption = "충청도 사례", align = rep("r", 3))
```
