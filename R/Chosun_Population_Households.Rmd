...
```{r}
knitr::include_graphics("../pics/chosun_population_households.png", dpi = 96)
```
...
g5 <- g4 + scale_colour_manual(name = "구분", values = c("red", "blue"), labels = c("호수", "인구수")) 
g6 <- g5 + 
  theme(legend.position = c(0.2, 0.8), 
        legend.background = element_rect(colour = "black", linetype = "solid"))
g7 <- g6 + 
  ggtitle(main_title) +
  annotate("text", x = 1700, y = c(500, 100), label = c("인구", "호수"), family = "HCR Dotum LVT")
g7
