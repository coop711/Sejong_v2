...
pie.gg(vote.df, ggtitle = "전체 가부", font.family = "NanumGothic")
```
...
```{r, geom_bar for regional bureaus, fig.width = 12, fig.height = 5}
...
```{r, geom_bar for commons, fig.width = 8, fig.height = 5}
